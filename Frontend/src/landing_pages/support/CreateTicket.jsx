    ...
    return (
        <div className="container">
            <div className="row">
                ...
                <div className="col-4">
                    <h1 className="fs-5 my-5">
                        <i className="fa-solid fa-user fa-sm"></i> Your Zerodha
                        Account
                    </h1>
                    <a
                        href=""
                ...
                <div className="col-4">
                    <h1 className="fs-5 my-5">
                        <i className="fa-solid fa-chart-column fa-sm"></i> Kite
                    </h1>
                    <a
                        href=""
                        style={{
                ...
                <div className="col-4">
                    <h1 className="fs-5 my-5">
                        <i className="fa-solid fa-circle-notch fa-sm"></i>{" "}
                        Console
                    </h1>
                    <a
                        href=""
